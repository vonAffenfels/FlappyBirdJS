...
Game.States.Play.prototype = Object.create(Phaser.State.prototype);
Game.States.Play.prototype.constructor = Game.States.Play;
...
Game.States.Play.prototype._countdown = function () {
...
Game.States.Play.prototype._gameover = function () {
	this.started = false;
...
Game.States.Play.prototype._gameoverComplete = function () {
	// Show Gameover
...
Game.States.Play.prototype._onTap = function () {
	if (this.started) {
		this.bird.flap();
	}
